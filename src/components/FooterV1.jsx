...
export function FooterV1() {
  return (
    <footer className="relative w-full overflow-hidden text-white mt-auto border-t border-white/10">
      ...
      <div className="relative z-10 mx-auto max-w-[92%] lg:max-w-[1440px] px-4 py-8 sm:py-16 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 gap-6 md:gap-12 md:grid-cols-2 lg:grid-cols-12">
          ...
          <div className="flex flex-col lg:col-span-2 lg:col-start-7">
            <h4 className="mb-3 md:mb-6 text-lg sm:text-xl font-normal text-white">More</h4>
            <ul className="flex flex-col space-y-2 md:space-y-3 text-xs sm:text-sm text-white/80">
          ...
          <div className="flex flex-col lg:col-span-4 lg:col-start-9">
            <h4 className="mb-3 md:mb-6 text-lg sm:text-xl font-normal text-white">Contact Us</h4>
            <ul className="flex flex-col space-y-2.5 md:space-y-4 text-xs sm:text-sm text-white/80">
              <li className="flex items-start gap-3">
                <svg className="mt-0.5 h-4 w-4 sm:h-5 sm:w-5 shrink-0 text-[#fbbf24]" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" viewBox="0 0 24 24"><path d="M21 10c0 7-9 13-9 13s-9-6-9-13a9 9 0 0 1 18 0z"/><circle cx="12" cy="10" r="3"/></svg>
                <span className="leading-relaxed">Navrachna Foundation, Plot no. 46,<br /> Knowledge Park 3, Greater Noida</span>
              </li>
              <li className="flex items-center gap-3">
                <svg className="h-4 w-4 sm:h-5 sm:w-5 shrink-0 text-[#fbbf24]" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" viewBox="0 0 24 24"><path d="M22 16.92v3a2 2 0 0 1-2.18 2 19.79 19.79 0 0 1-8.63-3.07 19.5 19.5 0 0 1-6-6 19.79 19.79 0 0 1-3.07-8.67A2 2 0 0 1 4.11 2h3a2 2 0 0 1 2 1.72 12.84 12.84 0 0 0 .7 2.81 2 2 0 0 1-.45 2.11L8.09 9.91a16 16 0 0 0 6 6l1.27-1.27a2 2 0 0 1 2.11-.45 12.84 12.84 0 0 0 2.81.7A2 2 0 0 1 22 16.92z"/></svg>
                <span>+91 9540527700</span>
              </li>
              <li className="flex items-center gap-3">
                <svg className="h-4 w-4 sm:h-5 sm:w-5 shrink-0 text-[#fbbf24]" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" viewBox="0 0 24 24"><path d="M4 4h16c1.1 0 2 .9 2 2v12c0 1.1-.9 2-2 2H4c-1.1 0-2-.9-2-2V6c0-1.1.9-2 2-2z"/><polyline points="22,6 12,13 2,6"/></svg>
            ...
            <div className="mt-4 md:mt-8 flex gap-3">
              <a href="https://www.instagram.com/itsec_nfed" target="_blank" rel="noreferrer" className="flex h-9 w-9 sm:h-10 sm:w-10 items-center justify-center rounded-full bg-black/20 shadow-inner text-[#fbbf24] border border-white/10 backdrop-blur-md hover:-translate-y-1 hover:bg-white/10 transition-all duration-300">
              ...
              <a href="https://www.facebook.com/share/1EsxYHE9Rr/" target="_blank" rel="noreferrer" className="flex h-9 w-9 sm:h-10 sm:w-10 items-center justify-center rounded-full bg-black/20 shadow-inner text-[#fbbf24] border border-white/10 backdrop-blur-md hover:-translate-y-1 hover:bg-white/10 transition-all duration-300">
              ...
              <a href="https://www.linkedin.com/company/itsec-nfed/" target="_blank" rel="noreferrer" className="flex h-9 w-9 sm:h-10 sm:w-10 items-center justify-center rounded-full bg-black/20 shadow-inner text-[#fbbf24] border border-white/10 backdrop-blur-md hover:-translate-y-1 hover:bg-white/10 transition-all duration-300">
