...
export const programs = [
  {
    ...
    bullets: ['Idea validation', 'Lab access', 'Mentor reviews'],
  },
  {
    slug: 'startinup',
    title: 'StartinUP',
    ...
    bullets: ['Launch planning', 'Pitch prep', 'Go-to-market support'],
  },
  {
    slug: 'msme-bi',
    title: 'MSME-BI',
    ...
    bullets: ['Structured incubation', 'Compliance support', 'Market access'],
  },
  {
...
export const facilities = [
  {
    title: 'Fully equipped meeting rooms',
    detail: 'Professional rooms with presentation support for reviews, mentoring, and partner sessions.',
  },
  {
    title: 'Fabrication and prototyping support',
    detail: 'Hands-on tools that help founders test, iterate, and demonstrate quickly.',
  },
  {
    title: 'Reliable high-speed internet',
    detail: 'Connectivity that keeps the team focused on building instead of waiting.',
  },
  {
    title: 'Safe 24/7 access',
    detail: 'Extended access for founders working around schedules, deadlines, and launch cycles.',
  },
  {
    title: 'On-site refreshment and support',
    detail: 'Comfort and convenience that keeps long work sessions sustainable.',
  },
  {
    title: 'Security and surveillance',
    detail: 'A controlled environment designed for dependable daily use.',
  },
]
