    ...
    <div className="min-h-screen bg-slate-900 flex flex-col justify-center py-12 sm:px-6 lg:px-8 font-sans antialiased">
      ...
      <div className="mt-8 sm:mx-auto sm:w-full sm:max-w-md">
        <div className="bg-slate-800 py-8 px-6 shadow-2xl rounded-xl sm:px-10 border border-slate-700">
          ...
          {errorMsg && (
            <div className="mb-5 rounded-lg bg-red-500/10 border border-red-500/30 p-3 text-xs text-red-300">
              {errorMsg}
            </div>
          )}
          ...
          <form className="space-y-5" onSubmit={handleSubmit}>
            ...
            <div>
              ...
              <input
                ...
                className="w-full rounded-lg border border-slate-600 bg-slate-900 px-3.5 py-2.5 text-xs text-white placeholder:text-slate-500 focus:border-sky-400 focus:outline-none transition-colors"
              />
            </div>
            ...
            <div>
              <button
                type="submit"
                disabled={submitting}
                className="w-full flex justify-center py-2.5 px-4 border border-transparent rounded-lg text-xs font-medium text-white bg-[#074887] hover:bg-[#013759] focus:outline-none transition-colors shadow-md disabled:opacity-50 cursor-pointer"
              >
