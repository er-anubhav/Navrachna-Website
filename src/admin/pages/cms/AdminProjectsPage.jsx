        ...
        <div className="flex flex-col gap-6 font-normal text-slate-900">
          ...
          {loading ? (
            <div className="p-12 text-center bg-white rounded-2xl border border-slate-200 shadow-xs">
              ...
              <p className="text-xs text-slate-500 font-normal">Loading innovation projects...</p>
            </div>
          ) : filtered.length > 0 ? (
            viewMode === 'TABLE' ? (
              /* TABLE VIEW */
                      ...
                      <div>
                        ...
                        <div className="aspect-video w-full bg-slate-100 relative overflow-hidden">
                          ...
                          {item.image_url ? (
                            ...
                            <div className="w-full h-full bg-linear-to-br from-slate-800 to-[#013759] flex flex-col items-center justify-center p-4 text-center">
