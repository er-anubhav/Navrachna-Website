        ...
        <div className="flex flex-col gap-6 font-normal text-slate-900">
          ...
          <form onSubmit={handleSave} className="bg-white p-8 rounded-2xl border border-slate-200 shadow-sm flex flex-col gap-6 text-sm font-normal">
            ...
            <div className="bg-slate-50 p-6 rounded-2xl border border-slate-200 flex flex-col sm:flex-row items-center gap-6">
              <div className="w-24 h-24 bg-linear-to-br from-slate-100 to-slate-200 rounded-2xl border border-slate-300 shadow-xs overflow-hidden flex items-center justify-center p-3 shrink-0">
        ...
        <div className="flex flex-col gap-6 font-normal text-slate-900">
          ...
          {loading ? (
            <div className="p-12 text-center bg-white rounded-2xl border border-slate-200 shadow-xs">
              ...
              <p className="text-xs text-slate-500 font-normal">Loading startups...</p>
            </div>
          ) : viewMode === 'TABLE' ? (
                      ...
                      return (
                        <tr key={item.id} className={`hover:bg-slate-50/80 transition-colors ${isSelected ? 'bg-sky-50/40' : ''}`}>
                          ...
                          <td className="py-4 px-6">
                            <div className="flex items-center gap-3">
                              <div className="w-9 h-9 bg-linear-to-br from-slate-100 to-slate-200 rounded-lg border border-slate-200 overflow-hidden shrink-0 flex items-center justify-center p-1">
                          ...
                          <td className="py-4 px-6">
                            <div className="flex flex-col gap-0.5">
                              ...
                              <div className="flex items-center gap-2 text-[11px] font-mono text-slate-500">
                                ...
                                {p.email_id !== 'N/A' && <span className="truncate max-w-40">{p.email_id}</span>}
                              </div>
                            </div>
                          </td>
                          <td className="py-4 px-6">
